...
### Rendimiento
- El procesamiento puede tomar **5-15 segundos** dependiendo de:
  - Calidad de la imagen
  - Velocidad de conexión a internet
  - Carga del servidor de Gemini

### Limitaciones
- Requiere **conexión a internet** activa
- Calidad del OCR depende de:
  - Iluminación de la foto
  - Claridad del texto
  - Idioma del recibo (mejor en español e inglés)

### Recomendaciones de Uso
1. **Buena iluminación** al capturar
2. **Recibo plano** y completo en el encuadre
3. **Evitar reflejos** y sombras
4. **Revisar siempre** los datos extraídos antes de guardar

---

## 📞 Contacto y Soporte

Para problemas o mejoras relacionadas con el sistema de escaneo:
- **Repository:** DavisLCVB/Solea
- **Branch:** main
